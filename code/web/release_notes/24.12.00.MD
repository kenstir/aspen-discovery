...
- Update the record page to add a Request button for records needing Local ILL requests. (DIS-34) (*MDN)
- Update the holds process to use the Local ILL process when configured. (DIS-34) (*MDN)
